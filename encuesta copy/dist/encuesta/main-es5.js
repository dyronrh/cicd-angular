...
var EncuestaFormComponent = /** @class */ (function () {
    function EncuestaFormComponent(service, encuestaEventService) {
    ...
    EncuestaFormComponent.prototype.ngOnInit = function () {
    ...
    EncuestaFormComponent.prototype.onSubmit = function (form) {
        var _this = this;
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                swalWithBootstrapButtons.fire('Adicionando!', 'Usted a enviado la respuesta correctamente.', 'success').then(function (result) {
                    _this.service.addEncuestas(form.value).subscribe(function (res) {
                        ...
                        _this.encuestaEventService.toggle();
                        _this.encuesta.reset();
                    });
                });
            }
    ...
    EncuestaFormComponent.ctorParameters = function () { return [
...
var EncuestaEventService = /** @class */ (function () {
    function EncuestaEventService() {
        this.isAdd = false;
        this.change = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    EncuestaEventService.prototype.toggle = function () {
        this.isAdd = true;
...
var EncuestasComponent = /** @class */ (function () {
    function EncuestasComponent(service, encuestaEventService) {
        this.service = service;
        this.encuestaEventService = encuestaEventService;
    ...
    EncuestasComponent.prototype.ngAfterViewInit = function () {
        this.dsEncuestas.paginator = this.paginator;
    };
    EncuestasComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.encuestaEventService.change.subscribe(function (isAdd) {
            if (isAdd) {
                _this.listarEncuestas();
            }
        });
    };
    EncuestasComponent.prototype.listarEncuestas = function () {
        var _this = this;
        this.service.listarEncuestas().subscribe(function (result) {
            _this.dsEncuestas.data = result;
            console.log(result);
        }, function (error) {
        }, function () {
        });
    };
    EncuestasComponent.prototype.eliminarEncuesta = function (id) {
        var _this = this;
        var swalWithBootstrapButtons = sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.mixin({
            customClass: {
                confirmButton: 'btn btn-success',
                cancelButton: 'btn btn-danger'
            },
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                swalWithBootstrapButtons.fire('Eliminando!', 'Usted a eliminado la encuesta correctamente.', 'success').then(function (result) {
                    _this.service.deleteEncuesta(id).subscribe(function (res) {
    ...
    EncuestasComponent.ctorParameters = function () { return [
...
var EncuestaService = /** @class */ (function () {
    ...
    EncuestaService.prototype.listarEncuestas = function () {
    ...
    EncuestaService.prototype.addEncuestas = function (body) {
    ...
    EncuestaService.prototype.updateEncuestas = function (id, body) {
    ...
    EncuestaService.prototype.deleteEncuesta = function (id) {
...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.handleAuthError = function (error) {
        console.log(error);
        switch (error.status) {
            case 0:
            ...
            case 401:
                try {
                    ...
                    var object = JSON.parse(error.error);
                    var details = JSON.parse(object.details);
